...
| Start session | Existing **SW2 RESET → U1 EN/pin8** restarts the powered module when released. Or configure RTC timer wake beforehand. Reconnect qualified J2 pack with USB absent after true disconnection. | Boot into bounded BLE-ready session. |
