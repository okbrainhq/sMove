...
Old compact-placement reviews are archival, NOT part of the current assembly; see the [bounded cleanup inventory](../docs/revision-r2/two-part-case/integration-cleanup.md) for their status.
