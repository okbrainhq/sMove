...
Use only a qualified protected **1S 4.2V** pack, with **121mA / 4.23V acceptance**, supervised off-body charging and **no TS cell-temperature monitoring**. Cable, fit, radio, thermal, USB and bench gates remain open. GUI review was blocked and has not been resumed; retained previews are not a new visual approval.
